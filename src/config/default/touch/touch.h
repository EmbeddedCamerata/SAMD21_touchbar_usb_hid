...
{                                                                                                                  \
   X_NONE, Y(1), (uint8_t)PRSC_DIV_SEL_4, NODE_GAIN(GAIN_1, GAIN_1), (uint8_t)FILTER_LEVEL_16                   \
}
...
{                                                                                                              \
    (uint8_t)SCROLLER_TYPE_SLIDER, 0u, 3u,                            \
		SCROLLER_RESOL_DEADBAND((uint8_t)SCR_RESOL_7_BIT, (uint8_t)SCR_DB_8_PERCENT),(uint8_t)8,20\
}
